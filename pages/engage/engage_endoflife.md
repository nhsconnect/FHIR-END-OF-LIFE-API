...
4a.	GP system links directly to partner EPaCCS.
4b. GP system uses FHIR EoL dataset API available on partner EPaCCS to update the patient EoL data.
...
•	EoL information to be updated and shared must, as a min
